package com.paypad.parator.utils.sunmiutils;
...
public class SunmiPrintHelper {
     ...
     */
    public void checkSunmiPrinterService(SunmiPrinterService service){
        boolean ret = false;
        try {
    ...
    public int getSunmiPrinter() {
        return sunmiPrinter;
    }

    public void setSunmiPrinter(int sunmiPrinter) {
    ...
    public void setSunmiPrinterService(SunmiPrinterService sunmiPrinterService) {
        this.sunmiPrinterService = sunmiPrinterService;
    }

    public static SunmiPrintHelper getHelper() {
        return helper;
    }

    public static void setHelper(SunmiPrintHelper helper) {
        SunmiPrintHelper.helper = helper;
    }

    public InnerPrinterCallback getInnerPrinterCallback() {
        return innerPrinterCallback;
    }

    public void setInnerPrinterCallback(InnerPrinterCallback innerPrinterCallback) {
        this.innerPrinterCallback = innerPrinterCallback;
    }

    public static int getLostSunmiPrinter() {
        return LostSunmiPrinter;
    }

    public static void setLostSunmiPrinter(int lostSunmiPrinter) {
