...
public class KeyPadPasscodeCreate extends TableLayout {
    ...
    public KeyPadPasscodeCreate(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void inflateNumpad(Context context) {
        View view = inflate(context, R.layout.keypad_passcode_create, this);
    ...
    public void setBackBtnText(@NonNull Context context, String text){
        btnNumpadBack.setText(text);
    }
