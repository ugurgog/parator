...
public class CustomShowcaseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ShowcaseView.Builder(this)
                ...
                .setContentTitle("custom_text_painting_title")
                .setContentText("custom_text_painting_text")
    ...
    private static class CustomShowcaseView implements ShowcaseDrawer {
        ...
        public CustomShowcaseView(Resources resources) {
            width = resources.getDimension(R.dimen.product_imageview_default_size);
            height = resources.getDimension(R.dimen.custom_button_length_size);
            ...
            eraseColour = resources.getColor(R.color.transparentBlack, null);
