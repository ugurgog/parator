...
import com.paypad.parator.enums.ChartSaleSelectionEnum;
...
public class ChartManager3 {
    ...
    private List<ChartSales> getOneDaySalesList(){
        ...
        for(SaleModel saleModel: saleModels){
            ...
            if(DataUtils.getHourNumOfDate(saleModel.getOrder().getCreateDate()) != previousHour){
                ...
                chartOneDaySales1.setNetAmount(grossSalesAmount - saleModel.getOrder().getTotalDiscountAmount());
                ...
                for(ChartSales chartOneDaySales : chartOneDaySalesList){
                    if(chartOneDaySales.getHour() == DataUtils.getHourNumOfDate(saleModel.getOrder().getCreateDate())){
                        ...
                        chartOneDaySales.setNetAmount(chartOneDaySales.getGrossAmount() - saleModel.getOrder().getTotalDiscountAmount());
    ...
    private List<ChartSales> getThreeMonthSalesList(){
        ...
        for(SaleModel saleModel: saleModels){
            ...
            int currentDay = DataUtils.getDayOfYearFromDate(saleModel.getOrder().getCreateDate());
    ...
    private List<ChartSales> getOneYearSalesList(){
        ...
        for(SaleModel saleModel: saleModels){
            ...
            int currentMonth = DataUtils.getMonthNumFromDate(saleModel.getOrder().getCreateDate());
    ...
    private List<ChartSales> getUndefinedSalesList(){
        ...
        for(SaleModel saleModel: saleModels){
            ...
            int currentMonth = Integer.parseInt(String.valueOf(DataUtils.getYearFromDate(saleModel.getOrder().getCreateDate()))
                    .concat(String.valueOf(DataUtils.getMonthNumFromDate(saleModel.getOrder().getCreateDate()))));
