...
public class OneMonthSaleFragment extends BaseFragment {
    ...
    @BindView(R.id.oneMonthSalesSummaryRl)
    RelativeLayout oneMonthSalesSummaryRl;
    ...
    public OneMonthSaleFragment(Date startDate, Date endDate, boolean isThisDevice) {
    ...
    private void addSaleOverviewFragment(){
        if(isSaleOverviewDisplayed){
            ReportUIHelper.addSaleOverviewFragment(Objects.requireNonNull(getActivity()), reportModel, R.id.oneMonthSalesSummaryRl);
            salesSummaryTv.setText(getResources().getString(R.string.sales_summary_overview));
        }else {
            ReportUIHelper.addSaleDetailsFragment(Objects.requireNonNull(getActivity()), reportModel, R.id.oneMonthSalesSummaryRl);
