...
public class XTermReportFragment extends BaseFragment implements ReturnFinancialReportItemCallback {
    ...
    private void initVariables() {
        toolbarTitleTv.setText(CommonUtils.getLanguage().equals(LANGUAGE_TR) ? FinancialReportsEnum.X_TERM_REPORT.getLabelTr() : FinancialReportsEnum.X_TERM_REPORT.getLabelEn());
