...
public class OneWeekSaleFragment extends BaseFragment {
    ...
    @BindView(R.id.oneWeekSalesSummaryRl)
    RelativeLayout oneWeekSalesSummaryRl;
    ...
    public OneWeekSaleFragment(Date startDate, Date endDate, boolean isThisDevice) {
    ...
    private void addSaleOverviewFragment(){
        if(isSaleOverviewDisplayed){
            ReportUIHelper.addSaleOverviewFragment(Objects.requireNonNull(getActivity()), reportModel, R.id.oneWeekSalesSummaryRl);
            salesSummaryTv.setText(getResources().getString(R.string.sales_summary_overview));
        }else {
            ReportUIHelper.addSaleDetailsFragment(Objects.requireNonNull(getActivity()), reportModel, R.id.oneWeekSalesSummaryRl);
